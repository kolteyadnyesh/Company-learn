...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login,width=720,height=440,bg="#080000")
    login_canvas.pack()

    login_frame = Frame(login_canvas,bg="red")
    login_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(login_frame,text="Quiz App Login",fg="black",bg="red")
    ...
    log.configure(width = 15,height=1, activebackground = "#E53333", relief = FLAT)
...
def signUpPage():
    ...
    sup_canvas = Canvas(sup,width=720,height=440,bg="#080500")
    sup_canvas.pack()

    sup_frame = Frame(sup_canvas,bg="#F50505")
    sup_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(sup_frame,text="Quiz App SignUp",fg="#080000",bg="#F50505")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)
    ...
    sp.configure(width = 15,height=1, activebackground = "#E53333", relief = FLAT)
    sp.place(relx=0.4,rely=0.8)

    log = Button(sup_frame,text='Already have a Account?',padx=5,pady=5,width=5,command = gotoLogin,bg="#F50505", fg="black")
    log.configure(width = 16,height=1, activebackground = "#E53333", relief = FLAT)
...
def menu(abcdefgh):
    ...
    menu_frame = Frame(menu_canvas,bg="#FF0000")
    menu_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    
    
    wel = Label(menu_canvas,text=' W E L C O M E  T O  Q U I Z  S T A T I O N ',fg="black",bg="black") 
    wel.config(font=('calibri 18'))
    wel.place(relx=0.1,rely=0.02)
    
    abcdefgh='Welcome '+ abcdefgh
    level34 = Label(menu_frame,text=abcdefgh,bg="red",font="calibri 18",fg="black")
    level34.place(relx=0.17,rely=0.15)
    
    level = Label(menu_frame,text='Select your Difficulty Level !!',bg="red",font="calibri 18")
    level.place(relx=0.25,rely=0.3)
    
    
    var = IntVar()
    easyR = Radiobutton(menu_frame,text='Easy',bg="#FF0000",font="calibri 16",value=1,variable = var)
    easyR.place(relx=0.25,rely=0.4)
    
    mediumR = Radiobutton(menu_frame,text='Medium',bg="#FF0000",font="calibri 16",value=2,variable = var)
    mediumR.place(relx=0.25,rely=0.5)
    
    hardR = Radiobutton(menu_frame,text='Hard',bg="#FF0000",font="calibri 16",value=3,variable = var)
...
def easy():
    ...
    easy_canvas = Canvas(e,width=720,height=440,bg="red")
    easy_canvas.pack()

    easy_frame = Frame(easy_canvas,bg="#FF0000")
    ...
    a = Radiobutton(easy_frame,text=easyQ[x][1],font="calibri 10",value=easyQ[x][1],variable = var,bg="#FF0000")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(easy_frame,text=easyQ[x][2],font="calibri 10",value=easyQ[x][2],variable = var,bg="#FF0000")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(easy_frame,text=easyQ[x][3],font="calibri 10",value=easyQ[x][3],variable = var,bg="#FF0000")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(easy_frame,text=easyQ[x][4],font="calibri 10",value=easyQ[x][4],variable = var,bg="#FF0000")
...
def medium():
    ...
    med_canvas = Canvas(m,width=720,height=440,bg="#B50202")
    med_canvas.pack()

    med_frame = Frame(med_canvas,bg="#B50202")
    ...
    a = Radiobutton(med_frame,text=mediumQ[x][1],font="calibri 10",value=mediumQ[x][1],variable = var,bg="#B50202")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(med_frame,text=mediumQ[x][2],font="calibri 10",value=mediumQ[x][2],variable = var,bg="#B50202")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(med_frame,text=mediumQ[x][3],font="calibri 10",value=mediumQ[x][3],variable = var,bg="#B50202")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(med_frame,text=mediumQ[x][4],font="calibri 10",value=mediumQ[x][4],variable = var,bg="#B50202")
    d.place(relx=0.5,rely=0.72,anchor=CENTER) 
...
def difficult():
    ...
    hard_canvas = Canvas(h,width=720,height=440,bg="#F56C6C")
    hard_canvas.pack()

    hard_frame = Frame(hard_canvas,bg="#F56C6C")
    ...
    a = Radiobutton(hard_frame,text=hardQ[x][1],font="calibri 10",value=hardQ[x][1],variable = var,bg="#F56C6C",fg="black")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(hard_frame,text=hardQ[x][2],font="calibri 10",value=hardQ[x][2],variable = var,bg="#F56C6C",fg="black")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(hard_frame,text=hardQ[x][3],font="calibri 10",value=hardQ[x][3],variable = var,bg="#F56C6C",fg="black")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(hard_frame,text=hardQ[x][4],font="calibri 10",value=hardQ[x][4],variable = var,bg="#F56C6C",fg="black")
    d.place(relx=0.5,rely=0.72,anchor=CENTER) 
...
def start():
    ...
    button = Button(root, text='Start',command = signUpPage,bg="black",fg="red") 
    button.configure(width = 102,height=2, activebackground = "#E53333", relief = RAISED)
